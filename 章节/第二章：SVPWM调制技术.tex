...
设克拉克-帕克逆变换得到的三相电压为\(U_{\mathrm{a}},U_{\mathrm{b}},U_{\mathrm{c}}\)。
其中的最大值为\(U_{\mathrm{\max}}=\max(U_{\mathrm{a}},U_{\mathrm{b}},U_{\mathrm{c}})\)
最小值为\(U_{\mathrm{\min}}=\min(U_{\mathrm{a}},U_{\mathrm{b}},U_{\mathrm{c}})\)
则零序分量将会满足（具体严格的推导个人能力不足，在此省略）
\begin{equation}
    U_{\mathrm{0}}=-\cfrac 12(U_{\mathrm{\max}}+U_{\mathrm{\min}})
    \label{eq:零序分量表达式}
\end{equation}
...
\begin{equation}
    \begin{cases}
        D_{\mathrm{A}}=\cfrac 12+\cfrac{U_{\mathrm{a}}'}{U_{\mathrm{dc}}}=
        \cfrac{1}{2}+\cfrac{U_{\mathrm{a}}+U_{\mathrm{0}}}{U_{\mathrm{dc}}}
        \\
        D_{\mathrm{B}}=\cfrac 12+\cfrac{U_{\mathrm{b}}'}{U_{\mathrm{dc}}}=\cfrac{1}{2}+
        \cfrac{U_{\mathrm{b}}+U_{\mathrm{0}}}{U_{\mathrm{dc}}}
        \\
        D_{\mathrm{C}}=\cfrac 12+\cfrac{U_{\mathrm{c}}'}{U_{\mathrm{dc}}}=\cfrac{1}{2}+
        \cfrac{U_{\mathrm{c}}+U_{\mathrm{0}}}{U_{\mathrm{dc}}}
    \end{cases}\
